        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="{{ route('pemetaan.form') }}"
                    class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition group">
                    <div class="flex items-center mb-3">
                        <div
                            class="w-10 h-10 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center group-hover:bg-blue-100 transition">
                ...
                <a href="{{ route('pemetaan.import') }}"
                    ...
                    <div class="flex items-center mb-3">
                        <div
                            class="w-10 h-10 rounded-lg bg-orange-50 text-orange-600 flex items-center justify-center group-hover:bg-orange-100 transition">
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition group cursor-pointer">
                    <div class="flex items-center mb-3">
                        <div
                            class="w-10 h-10 rounded-lg bg-purple-50 text-purple-600 flex items-center justify-center group-hover:bg-purple-100 transition">
                ...
                @forelse($aktivitasTerbaru as $item)
                    <div class="px-6 py-4 flex items-center justify-between">
                        <div class="flex items-center">
                            <div
                                class="w-10 h-10 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center mr-3">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            {{ $item->sumber_beasiswa == 'beasiswa' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700' }}">
                                <i
                                    class="fas {{ $item->sumber_beasiswa == 'beasiswa' ? 'fa-star' : 'fa-close' }} mr-1"></i>
